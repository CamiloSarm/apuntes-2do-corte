...
Si una señal de entrada sinusoidal es \( R(t) = A \sin (\omega kT + \theta) \), su representación en fasores es \( R = A \angle \theta \), donde \( A \) es la amplitud y \( \theta \) es la fase de la señal.
